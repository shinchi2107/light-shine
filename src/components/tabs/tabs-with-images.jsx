...
const TabsWithImages = ({ tabs, className = '' }) => {
    const [activeTab, setActiveTab] = useState(1);
    const [blink, setBlink] = useState(false);
    return (
        <div className={`tabs-with-images ${className}`}>
            <div className="tabs-container max-w-[1000px] 2xl:max-w-[1300px] mx-auto relative">
                {tabs.map((tab) => (
